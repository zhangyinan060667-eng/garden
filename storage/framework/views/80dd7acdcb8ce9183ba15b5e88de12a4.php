              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Name of Client" name="name" value="<?php echo e($client->name); ?>" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div style="width: 250px; height: 90px;">
                      <img src="<?php echo e(asset('images/'.$client->image)); ?>" style="height: 100%; width: 100%;">
                  </div>
...
<?php echo $__env->make('admin/scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\zhang\web\resources\views\admin\edit-client.blade.php ENDPATH**/ ?>