              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr>
                    <td><?php if($event->event_date): ?><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('jS F Y')); ?><?php endif; ?></td>
                    <td><?php echo e($event->title); ?></td>
                    <td><?php echo e($event->details); ?></td>
                    <td><a href="/admin/edit-events/<?php echo e($event->id); ?>" class="btn btn-primary">Edit</a></td>
                    <td><a href="/admin/view-events/<?php echo e($event->id); ?>" class="btn btn-primary">Delete</a></td>
                  </tr>
...
<?php /**PATH C:\Users\zhang\web\resources\views\admin\view-events.blade.php ENDPATH**/ ?>