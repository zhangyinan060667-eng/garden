...
<!-- flot -->
<!-- FLOT CHARTS -->
<script src="<?php echo e(asset('admin/plugins/flot/jquery.flot.js')); ?>"></script>
<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
<script src="<?php echo e(asset('admin/plugins/jquery.flot.resize.js')); ?>"></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src="<?php echo e(asset('admin/plugins/jquery.flot.pie.js')); ?>"></script>
<!-- Page specific script -->
<script>
  $(function () {
    /*
...
<!-- uplot -->
<!-- uPlot -->
<script src="<?php echo e(asset('admin/plugins/uplot/uPlot.iife.min.js')); ?>"></script>
<script>
  $(function () {
    /* uPlot
     * -------
  ...
  $(function() {
    ...
    $('.toastsDefaultFullImage').click(function() {
      $(document).Toasts('create', {
        ...
        title: 'Toast Title',
        subtitle: 'Subtitle',
        image: "<?php echo e(asset('../../dist/img/user3-128x128.jpg')); ?>",
...
<!-- editors -->
<!-- CodeMirror -->
<script src="<?php echo e(asset('admin/plugins/codemirror/codemirror.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/codemirror/mode/css/css.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/codemirror/mode/xml/xml.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/codemirror/mode/htmlmixed/htmlmixed.js')); ?>"></script>
<script>
  $(function () {
    // Summernote
...
<!-- jsgrid -->
<!-- jsGrid -->
<script src="<?php echo e(asset('admin/plugins/jsgrid/demos/db.js')); ?>"></script>
<script src="<?php echo e(asset('admin/plugins/jsgrid/jsgrid.min.js')); ?>"></script>
<script>
  $(function () {
    $("#jsGrid1").jsGrid({
        height: "100%",
...
<!-- calender -->
<!-- fullCalendar 2.2.5 -->
<script src="<?php echo e(asset('admin/plugins/fullcalendar/main.js')); ?>"></script>
<script>
  $(function () {
...
<!-- Filterizr-->
<script src="<?php echo e(asset('admin/plugins/filterizr/jquery.filterizr.min.js')); ?>"></script>
<!-- Page specific script -->
<script>
  $(function () {
...
<!-- pace-progress -->
<script src="<?php echo e(asset('admin/plugins/pace-progress/pace.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\zhang\web\resources\views\admin\scripts.blade.php ENDPATH**/ ?>