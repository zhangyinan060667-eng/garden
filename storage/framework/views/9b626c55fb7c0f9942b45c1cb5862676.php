                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr>
                    ...
                    <td><?php echo e($blog->short_details); ?></td>
                    <td><?php echo e($blog->full_details); ?></td>
                    <td align="center">
                         <div style="width: 250px; height: 200px;"><img src="<?php echo e(asset('images/'.$blog->image)); ?>" style="height: 100%; width: 100%; object-fit: cover;"></td></div>
                    </td>
                    <td><a href="/admin/edit-gallery/<?php echo e($blog->id); ?>" class="btn btn-primary">Edit</a></td>
                    <td><a href="/admin/view-gallery/<?php echo e($blog->id); ?>" class="btn btn-primary">Delete</button></td>
                  </tr>
...
<?php /**PATH C:\Users\zhang\web\resources\views\admin\view-blog.blade.php ENDPATH**/ ?>