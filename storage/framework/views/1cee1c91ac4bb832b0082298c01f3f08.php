...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/dropzone/min/dropzone.min.css')); ?>">
   ...
   <!-- CodeMirror -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/codemirror/codemirror.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/codemirror/theme/monokai.css')); ?>">
  <!-- SimpleMDE -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/simplemde/simplemde.min.css')); ?>">

  <!-- jsGrid -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/jsgrid/jsgrid.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/jsgrid/jsgrid-theme.min.css')); ?>">

  <!-- fullCalendar -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/fullcalendar/main.css')); ?>">
  ...
  <!-- pace-progress -->
  <link rel="stylesheet" href="<?php echo e(asset('admin/plugins/pace-progress/themes/black/pace-theme-flat-top.css')); ?>">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <?php $__currentLoopData = $adminMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="nav-item">
              <a href="<?php echo e($menu['href']); ?>" class="nav-link">
...
<?php /**PATH C:\Users\zhang\web\resources\views\admin\header.blade.php ENDPATH**/ ?>